...
private:
	...
	//Desciption: helper function for copy constructor and destructor
	void copyBST(BSTNode<ElementType>* root, BSTNode<ElementType>* newroot);
	void deleteBST(BSTNode<ElementType>* root);
